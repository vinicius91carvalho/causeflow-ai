...
SSO / SAML for centralized identity provider integration may be available depending on your deployment configuration. See the [CauseFlow monorepo](https://github.com/vinicius91carvalho/causeflow-ai) and [published docs](https://vinicius91carvalho.github.io/causeflow-ai/docs/) for local auth setup.
