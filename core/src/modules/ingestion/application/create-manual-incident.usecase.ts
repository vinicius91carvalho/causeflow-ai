...
export class CreateManualIncidentUseCase {
    ...
    constructor(repo: IIncidentRepository, eventBus: IEventBus, messageQueue?: MessageQueue, alertQueueUrl?: string, investigationQueueUrl?: string) {
        this.repo = repo;
