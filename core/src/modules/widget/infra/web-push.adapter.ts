import type { PushSubscriptionData, PushNotificationPayload } from '../domain/push-subscription.types.js';
...
export class WebPushAdapter {
    ...
    async send(subscription: PushSubscriptionData, payload: PushNotificationPayload): Promise<boolean> {
