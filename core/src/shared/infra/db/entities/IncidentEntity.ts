...
export const IncidentEntity = new Entity({
    ...
    indexes: {
        primary: { collection: 'incidentDetails', pk: { field: 'pk', composite: ['tenantId'] }, sk: { field: 'sk', composite: ['incidentId'] } },
        bySeverityStatus: { index: 'gsi1', pk: { field: 'gsi1pk', composite: ['tenantId', 'severity'] }, sk: { field: 'gsi1sk', composite: ['status'] } },
        byCreatedAt: { index: 'gsi2', pk: { field: 'gsi2pk', composite: ['tenantId'] }, sk: { field: 'gsi2sk', composite: ['createdAt'] } },
        bySourceAlert: { index: 'gsi3', pk: { field: 'gsi3pk', composite: ['tenantId', 'sourceProvider'] }, sk: { field: 'gsi3sk', composite: ['sourceAlertId'] } },
    },
