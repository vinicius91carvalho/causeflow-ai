...
export const TenantEntity = new Entity({
    ...
    attributes: {
        ...
        settings: { type: 'map', properties: {
                ...
                widgetConfig: { type: 'map', properties: {
                    enabled: { type: 'boolean' },
                    allowedOrigins: { type: 'list', items: { type: 'string' } },
                    customDomain: { type: 'string' },
                    branding: { type: 'map', properties: {
                        primaryColor: { type: 'string' },
                        logoUrl: { type: 'string' },
                        headerText: { type: 'string' },
                        welcomeMessage: { type: 'string' },
                    } },
                    dataMasking: { type: 'map', properties: {
                        enabled: { type: 'boolean' },
                        rules: { type: 'any' },
                    } },
                ...
                slackConfig: { type: 'map', properties: {
    ...
    indexes: {
        ...
        bySlug: { index: 'gsi1', pk: { field: 'gsi1pk', composite: ['slug'] }, sk: { field: 'gsi1sk', composite: [] } },
        byOwner: { index: 'gsi2', pk: { field: 'gsi2pk', composite: ['ownerEmail'] }, sk: { field: 'gsi2sk', composite: ['createdAt'] } },
        byCustomDomain: { index: 'gsi3', pk: { field: 'gsi3pk', composite: ['customDomain'] }, sk: { field: 'gsi3sk', composite: [] } },
    },
