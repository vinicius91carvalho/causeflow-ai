...
<Steps>
  ...
  <Step title="Get your relay token">
    1. Log in to the [CauseFlow Dashboard](https://dashboard.causeflow.ai).
  ...
  <Step title="Verify the connection">
    **Option 1 — Dashboard:** Open the [CauseFlow Dashboard](https://dashboard.causeflow.ai) and go to **Settings** → **Relay**. Your relay should appear in the connections list within a few seconds with a green status indicator.
