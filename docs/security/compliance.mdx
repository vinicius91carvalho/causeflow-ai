...
**Data residency:** CauseFlow infrastructure is hosted on AWS. Contact [sales@causeflow.ai](mailto:sales@causeflow.ai) if you have specific data residency requirements for Enterprise plans.
